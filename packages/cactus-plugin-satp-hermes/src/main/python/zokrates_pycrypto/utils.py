...
def write_signature_to_json(pk, sig, msg):
    sig_R, sig_S = sig
    args = [sig_R.x, sig_R.y, sig_S, pk.p.x.n, pk.p.y.n]
    args = " ".join(map(str, args))
    ...
    data = {}
    data["R"] = [args2[0], args2[1]]
    data["S"] = args2[2]
    data["A"] = [args2[3], args2[4]]
    data["M0"] = [args2[5], args2[6], args2[7], args2[8], args2[9], args2[10], args2[11], args2[12]]
    data["M1"] = [args2[13], args2[14], args2[15], args2[16], args2[17], args2[18], args2[19], args2[20]]
