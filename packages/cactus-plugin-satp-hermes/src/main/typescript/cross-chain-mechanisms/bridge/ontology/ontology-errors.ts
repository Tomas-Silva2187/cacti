...
export class OntologyFunctionNotAvailable extends OntologyInternalError {
  constructor(
    ...
    super(`Ontology function ${nonAvailableFunction} stated as not available`, cause ?? null, 500, traceID, trace);
  }
}
...
export class OntologyFunctionVariableNotSupported extends OntologyInternalError {
  constructor(
    ...
    super(`Ontology function variable ${variable} not supported by ledger ${ledgerType}`, cause ?? null, 500, traceID, trace);
  }
}
...
export class UnknownInteractionError extends OntologyInternalError {
  constructor(
    ...
    super(`Unknown interaction type: ${interaction}`, cause ?? null, 500, traceID, trace);
  }
}
