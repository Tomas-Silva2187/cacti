...
import { InteractionWithoutFunctionError, InvalidOntologyHash, InvalidOntologySignature, OntologyFunctionVariableNotSupported, OntologyNotFoundError } from "../../../../main/typescript/cross-chain-mechanisms/bridge/ontology/ontology-errors";
...
describe("OntologyManager", () => {
  ...
  const mockOntologyContent1 = JSON.stringify({
    ...
    bytecode: "",
    signature: "108,84,11,146,64,104,110,52,85,203,252,165,89,168,22,94,150,103,204,235,80,57,198,34,255,153,59,201,220,100,34,126,44,164,224,9,243,251,21,251,250,185,17,153,152,206,15,125,198,198,96,91,56,62,3,234,247,227,24,229,19,55,174,108",
  ...
  const mockOntologyContent2 = JSON.stringify({
    ...
    bytecode: "",
    signature: "127,112,73,26,87,234,105,35,39,200,210,14,154,182,85,61,21,24,205,39,69,95,107,220,179,58,116,195,117,250,178,136,117,243,124,182,26,222,6,5,127,202,10,127,209,178,129,20,89,161,233,70,99,53,142,208,86,200,42,238,224,88,98,122",
  ...
  test("should throw InvalidOntologyHash if ontology hash is invalid", () => {
    ...
    expect(() =>
       new OntologyManager(options, monitorService, undefined, undefined, OntologyCheckLevel.HASHED),
  ...
  test("should throw InvalidOntologySignature if ontology signature is invalid", () => {
    ...
    expect(() =>
      new OntologyManager(options, monitorService, undefined, undefined, OntologyCheckLevel.HASHED_SIGNED),
  ...
  test("should throw InteractionWithoutFunctionError for an incomplete interaction in the ontology", () => {
    ...
    expect(() =>
      new OntologyManager(options, monitorService, undefined, undefined, OntologyCheckLevel.DEFAULT),
